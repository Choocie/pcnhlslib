#ifndef CALOCLUSTERNETV1_H__
#define CALOCLUSTERNETV1_H__
...
template<
    ...
    int ENERGY_OFFSET,
	int LUT_SIZE>
void caloclusternetv3(hls::stream<array<model_input_t,  MODEL_INPUT_WIDTH>>  inputStream[PAR],
	...
	hls::stream<array<model_input_t, ENERGY_WIDTH>,II*16> energyInputStream[PAR];
